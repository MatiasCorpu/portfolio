    ...
    <>
      <div className="w-full h-full flex justify-center">
        ...
        <div className="flex w-10/12 flex-col justify-center gap-4 mb-28 mt max-md:mb-4 max-md:w-full max-md:mx-2">
          <h1 className="text-4xl font-bold ml-20 mt-6 mb-2 text-slate-600 dark:text-zinc-300 max-xl:ml-2">University</h1>
          ...
          {Object.keys(groupedItems).map((year) => (
            ...
            <div className="flex items-center">
              ...
              <div className="h-full w-full flex max-lg:flex-col max-lg:gap-9">
                ...
                <div key={year} className="w-full flex flex-wrap max-xl:justify-center gap-5">
