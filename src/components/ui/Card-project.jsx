...
function CardProject({ classNameAditional, image, altImage, title, backgroundTitle, idLanguages, description, urlPage, urlGithub, items }) {
    ...
    return (
        ...
        <Card
            classNameAditional={"ml-2 font-mono text-slate-700"}
        >
            ...
            <div>
                ...
                <div className="flex w-full">
                    <Card classNameAditional={"w-1/2"} paddingContent={"px-3 py-2"}>
                        <a className="flex justify-center" href={urlGithub} target="_blank" rel="noreferrer">
                            <IconBrandGithub />
                        </a>
                    </Card>

                    <Card classNameAditional={"w-1/2"} paddingContent={"px-3 py-2"}>
                        <a className="flex justify-center" href={urlPage} target="_blank" rel="noreferrer">
                            <IconWorldWww />
                        </a>
                    </Card>
                </div>
